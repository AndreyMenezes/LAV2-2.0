...
# Iury Gregory - Versão 2.0 Março

require(nortest)

sessoes <- read.csv("dados/tableSumPerTestForadeAula.csv",header=T)
...
# SessoesAcm x Prova2
png(filename = "TamanhoSessoesProva2Acm-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
...
png(filename = "TamanhoSessoesProva3Acm-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
...
#Sessoes x Prova1
png(filename = "TamanhoSessoesProva1-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
...
png(filename = "NotaProva1-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
...
#Sessoes x Prova2
png(filename = "TamanhoSessoesProva2-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
...
png(filename = "NotaProva2-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
...
#Sessoes x Prova 3
png(filename = "TamanhoSessoesProva3-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
...
png(filename = "NotaProva3-ForaDeAula.png", width=650)
par(mfrow=c(1,2))
