...
public class UC1 extends GraphicUC {
	...
	public UC1(PApplet p, PImage bg, PImage grid, String[] data1, String[] data2, String[] data3, String[] data4){
		super(p);
		this.bg = bg;
		this.grid = grid;
		this.data1 = data1;
	...
	private void loadData() {
		...
		lines = loadCSV(parent.loadStrings("UC1_Bayes_Prova2_Formatado.txt"));
		...
		lines = loadCSV(parent.loadStrings("UC1_Bayes_Prova3_Formatado.txt"));
