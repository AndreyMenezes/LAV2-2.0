...
public class UC3 extends GraphicUC {
	...
	private PImage bg1,bg2,logo;
	private String[] dados1, dados2;
	private int r = 4;
	
	public UC3(PApplet p,PImage bg1,PImage bg2,String[] dados1,String[] dados2) {
		super(p);
		this.parent = p;
		this.bg1 = bg1;
		this.bg2 = bg2;
	...
	public void generateValues() {
	  for (int i = 1; i < bubbles.length; i++) {
		String[] temp= parent.split(dados1[i],",");
	...
	public void generateValues2() {
	  for (int i = 1; i < bubbles.length; i++) {
		String[] temp= PApplet.split(dados2[i],",");
