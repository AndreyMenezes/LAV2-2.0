...
agrupamento1 <- kmeans(dados[,-1],3)
agrupamento2 <- kmeans(dados[,-1],4)
agrupamento3 <- kmeans(dados[,-1],5)
agrupamento4 <- kmeans(dados[,-1],6)


png("AgrupamentoK3.png",bg="transparent",width = 800, height = 600)
plot(dados$atividade,dados$tempo.total.estudo, col = agrupamento1$cluster)
points(agrupamento1$centers, col = 1:2, pch = 8, cex=2)
dev.off()

png("AgrupamentoK4.png",bg="transparent",width = 800, height = 600)
plot(dados$atividade,dados$tempo.total.estudo, col = agrupamento2$cluster)
points(agrupamento2$centers, col = 1:2, pch = 8, cex=2)
dev.off()

png("AgrupamentoK5.png",bg="transparent",width = 800, height = 600)
plot(dados$atividade,dados$tempo.total.estudo, col = agrupamento3$cluster)
points(agrupamento3$centers, col = 1:2, pch = 8, cex=2)
dev.off()

png("AgrupamentoK6.png",bg="transparent",width = 800, height = 600)
plot(dados$atividade,dados$tempo.total.estudo, col = agrupamento4$cluster)
